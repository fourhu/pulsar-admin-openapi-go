...
**ClusterDispatchRate** | Pointer to [**map[string]DispatchRate**](DispatchRate.md) |  | [optional] 
...
**ReplicatorDispatchRate** | Pointer to [**map[string]DispatchRate**](DispatchRate.md) |  | [optional] 
...
**SubscriptionDispatchRate** | Pointer to [**map[string]DispatchRate**](DispatchRate.md) |  | [optional] 
**SubscriptionAuthMode** | Pointer to **string** |  | [optional] 
**SubscriptionExpirationTimeMinutes** | Pointer to **int32** |  | [optional] 
**TopicDispatchRate** | Pointer to [**map[string]DispatchRate**](DispatchRate.md) |  | [optional] 
